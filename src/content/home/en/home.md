...
projectPage:
  ...
  problem:
    eyebrow: Problem
    title: What this project needed to solve
  constraints:
    eyebrow: Constraints
    title: Boundaries that shaped the implementation
  architecture:
    eyebrow: Architecture
    title: How the solution is structured
  tradeoffs:
    eyebrow: Trade-Offs
    title: Deliberate choices behind the current direction
  status:
    eyebrow: Status
    title: Current state
  links:
  ...
  nextStepsHeading: What comes next
---
